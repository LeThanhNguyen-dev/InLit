...
export default function Reading() {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-3xl font-black">Đọc hiểu</h1>
        <p className="text-vault-muted">Đọc passage và trích xuất từ vựng, collocation, paraphrase kiểu TOEIC.</p>
      </header>
            ...
            <article key={reading.id} className="card p-6">
              ...
              <div className="mt-5 grid gap-4 lg:grid-cols-2">
                <div className="rounded-xl bg-blue-50 p-4">
                  <h3 className="font-black text-blue-900">Từ/cụm app trích xuất</h3>
                ...
                <div className="rounded-xl bg-emerald-50 p-4">
                  ...
                  <div className="mt-3 space-y-2 text-sm text-emerald-900/80">
                    ...
                    {!extracted.paraphrases.length && !extracted.matches.length && <p>Chưa tìm thấy pattern rõ. Hãy tự thêm vào Sổ tay lỗi sai nếu gặp paraphrase mới.</p>}
                  </div>
                </div>
              </div>
            </article>
