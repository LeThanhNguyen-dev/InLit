import { BarChart3, BookOpen, Brain, CalendarCheck, Clock, FileText, Star } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div><h1 className="text-3xl font-black">Tiến độ</h1><p className="text-vault-muted">Toàn bộ dữ liệu học được lưu riêng trên trình duyệt của bạn.</p></div>
      ...
      <div className="grid gap-5 lg:grid-cols-[320px_1fr]">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <StatCard icon={BookOpen} value={snapshot.dueReviews.length} label="Từ cần ôn" bg="bg-red-50" color="text-red-600" />
        </div>
      </div>
